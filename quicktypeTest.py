...
event = "Ik ben nieuw hier"
nodesarr = []
node1 = Node("192.168.178.135", 90)
node2 = Node("192.34.243.3", 88)
nodesarr.append(node1)
nodesarr.append(node2)
myMessage = Message(event, nodesarr)

print (myMessage.to_dict())
